<?php
//echo "Test da página diadesorte";
?>
...
<div class="max-width">
    <div class="content">
                ...
                <div class="header">
                    <ul class="menu" id="menu-site">
                        <?php echo "<a href='".URL."mega-sena'>MEGA-SENA</a>"; 
                              ...
                              echo "<a href='".URL."dia-de-sorte' class='active'>DIA DE SORTE</a>";
                        ?>
                    </ul>
                </div><br>
                <div class="header">
       ...
       <div class="lockday">
                ...
                <div class="day"><?php echo "<a href='".URL."meuDia' class='fa-solid fa-square-caret-right'>
